...
# Exercice "Liste courses"

👉 À réaliser après avoir lu le cours "Advanced 1"

ecrivez votre code dans le fichier `liste_courses.py`, quand vous aurez terminé pensez à pusher votre code sur git.

## 🏁 Objectifs
Utilisation des concepts vu dans le cours Advanced 1, à savoir **manipuler des string**, **manipuler des listes**, **gérer une boucle de demande**
...
Quand il voit : affichez la liste de course avec les quantités pour chaque produits
